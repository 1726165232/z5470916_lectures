...
df_2020  = df_2020 = df.loc['2020']
utils.pprint(df_2020)

# Select all data for a given month
df_2020_11  = df_2020_11 = df.loc['2020-11'] # <mask>
utils.pprint(df_2020_11)

# Selecting date ranges using strings
df_2020_11_0204  = df_2020_11_0204 = df.loc['2020-11-02':'2020-11-04']
